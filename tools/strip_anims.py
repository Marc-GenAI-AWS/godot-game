...
keep = {"Walk_Loop", "Idle_Loop", "Idle_Talking_Loop", "Walk_Formal_Loop", "Jog_Fwd_Loop", "A_TPose", "Sitting_Idle_Loop", "Sitting_Talking_Loop", "Swim_Idle_Loop", "Swim_Fwd_Loop", "Crouch_Idle_Loop", "Jump_Start", "Jump_Loop", "Jump_Land"}
