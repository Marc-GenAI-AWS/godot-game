...
var body_scene := "res://core/characters/assets/Superhero_Female_FullBody.gltf"
var hair_scene := "res://core/characters/assets/Hair_Long.gltf"   # "" = none
var body_mesh_name := "Superhero_Female"
var hair_mesh_names: Array[String] = ["Hair_Long", "Eyebrows"]
var painted_texture := "res://core/characters/assets/T_Player_BaseColor.png"
var normal_texture := "res://core/characters/assets/T_Superhero_Female_Normal.png"   # "" = none
...
func _apply_materials() -> void:
	...
	skin.shader = load("res://core/shaders/skin.gdshader")
...
# Walkable area comes from the world context; obstacles from its field.
func _constrain(p: Vector3) -> Vector3:
	return ctx.resolve_obstacles(ctx.constrain(p), 0.3)


func _ground(p: Vector3) -> float:
	return ctx.walk_height(p.x, p.z)
