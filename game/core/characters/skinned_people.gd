...
const BODIES := {
	"F": {"scene": "res://core/characters/assets/Superhero_Female_FullBody.gltf", "body": "Superhero_Female", "eyes": "Eyes", "brows": "Eyebrows",
		"hairs": {"long": ["res://core/characters/assets/Hair_Long.gltf", "Hair_Long"], "buns": ["res://core/characters/assets/Hair_Buns.gltf", "Hair_Buns"],
			"parted": ["res://core/characters/assets/Hair_SimpleParted.gltf", "Hair_SimpleParted"], "buzz": ["res://core/characters/assets/Hair_BuzzedFemale.gltf", "Hair_BuzzedFemale"]},
		"outfits": ["T_F_bikini_pink", "T_F_bikini_teal", "T_F_bikini_black", "T_F_bikini_floral", "T_F_onepiece_red", "T_F_onepiece_navy"]},
	"M": {"scene": "res://core/characters/assets/Superhero_Male_FullBody.gltf", "body": "SuperHero_Male", "eyes": "Eyes", "brows": "Eyebrows",
		"hairs": {"buzz": ["res://core/characters/assets/Hair_Buzzed.gltf", "Hair_Buzzed"], "parted": ["res://core/characters/assets/Hair_SimpleParted.gltf", "Hair_SimpleParted"]},
		"outfits": ["T_M_trunks_blue", "T_M_trunks_red", "T_M_trunks_floral", "T_M_trunks_black"]},
}
const ANIM_SCENE := "res://core/characters/assets/ual_walk.glb"
...
static func outfit_material(name: String, tinted := true) -> StandardMaterial3D:
	...
	if not _outfit_mats.has(key):
		...
		m.albedo_texture = load("res://core/characters/assets/%s.png" % name)
...
static func hair_material(tex: String, tinted := true) -> StandardMaterial3D:
	...
	if not _hair_mats.has(key):
		var m := StandardMaterial3D.new()
		m.albedo_texture = load("res://core/characters/assets/%s.png" % tex)
		m.vertex_color_use_as_albedo = tinted
		m.roughness = 0.6
...
static func eye_material() -> StandardMaterial3D:
	if _eye_mat == null:
		...
		_eye_mat.albedo_texture = load("res://core/characters/assets/T_Eye_Brown.png")
