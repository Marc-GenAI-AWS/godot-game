...
# and a sparse scatter of shells along the tide line.
...
func build() -> void:
	...
	material.set_shader_parameter("wet_color", Color(0.4, 0.3, 0.16))
	material.set_shader_parameter("grain_scale", 1.7)
	material.set_shader_parameter("wet_width", 14.0)
	material.set_shader_parameter("sheet_strength", 1.8)
	...
	# Few shells and pebbles along the tide line, as one MultiMesh.
