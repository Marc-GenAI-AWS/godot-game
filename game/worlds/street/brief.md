...
| vehicles | Procedural cars (hatch, sedan, suv, pickup) with chamfered bodies, glossy paint, tinted glass, chrome trim, emissive lights, spoked rims and a contact shadow; parked along both kerbs; traffic in both lanes that follows at an honest gap. Cabins are open glasshouses (roof slab, pillars, thin glass, dark interior, seats) so drivers show; traffic cars carry baked seated drivers. Player car: small yellow hatchback with a black roof and a hinged driver door (door_l / door_point / seat metas for the driver layer). |
